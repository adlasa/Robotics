...
public class Robot extends SampleRobot {
	...
	public void operatorControl() {
		...
		while (isEnabled() && isOperatorControl()) {
			...
			if (!robot.hMode) {
				robot.tankdrive(left.getAxis(Joystick.AxisType.kX),
						right.getAxis(Joystick.AxisType.kX));
			}
			...
			// TEMPORARY COMMENT
			/*
			 * gyroAngle = gyro.getAngle(); gyroRate = gyro.getRate();
			 ...
			 * elevator.setMainLevel(Levels.MainLevel.ONE); } else if
			 * (buttonPanel.getRawButton(2)) {
			 * elevator.setMainLevel(Levels.MainLevel.TWO); } else if
			 * (buttonPanel.getRawButton(3)) {
			 * elevator.setMainLevel(Levels.MainLevel.THREE); } else if
			 * (buttonPanel.getRawButton(4)) {
			 * elevator.setMainLevel(Levels.MainLevel.FOUR); }
			 * 
			 * if(buttonPanel.getRawButton(5)) {
			 * elevator.setLevelMode(Levels.LevelMode.FLOOR);
			 * elevator.setManual(false); } else if
			 * (buttonPanel.getRawButton(6)) {
			 * elevator.setLevelMode(Levels.LevelMode.PLATFORM);
			 * elevator.setManual(false); } else if
			 * (buttonPanel.getRawButton(7)) {
			 * elevator.setLevelMode(Levels.LevelMode.STEP);
			 * elevator.setManual(false); } else if
			 * (buttonPanel.getRawButton(8)) { elevator.setManual(true); }
			 * 
			 * if(buttonPanel.getRawButton(8)) {
			 * elevator.setCarryObject(Levels.CarryObject.TOTE); } else if
			 * (buttonPanel.getRawButton(9)) {
			 * elevator.setCarryObject(Levels.CarryObject.CONTAINER); }
			 * 
			 * if(buttonPanel.getRawButton(10)) { elevator.setManual(true);
			 * elevator.manualUp(); } else if (buttonPanel.getRawButton(11)) {
			 * elevator.setManual(true); elevator.manualDown(); } else if
			 * (elevator.getManual()) { elevator.stop(); }
			 * 
			 * 
			 * switch(elevator.getLevelMode()) { case FLOOR: {
			 * buttonPanel.setOutputs(0); buttonPanel.setOutput(1,true); } case
			 * STEP: { buttonPanel.setOutputs(0); buttonPanel.setOutput(2,true);
			 * }
			 * 
			 * }
			 * 
